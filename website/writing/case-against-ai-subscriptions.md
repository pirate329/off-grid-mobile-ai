...
## What a subscription relationship does to the user
...
These models run on current consumer hardware. They are good enough for the majority of personal AI use cases. The primary bottleneck to using them is not the model itself but the software that makes them usable — the interface, the context management, the integration with your device.
